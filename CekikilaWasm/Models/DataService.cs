namespace CekikilaWasm.Models
{
    public class DataService
    {
        private readonly Item[] _items = {
            new() { Id=1, Name="Broyeur de végétaux"      , Tags = [ "Jardin", "Electrique" ], Description = "Broyeur <strong>électrique</strong> d'une puissance de 2800W et d'un diamètre de coupe maximum de 45 mm convient parfaitement à un usage régulier." },
